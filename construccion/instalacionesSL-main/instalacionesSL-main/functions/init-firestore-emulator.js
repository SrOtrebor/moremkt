/**
 * Script para inicializar Firestore EMULATOR con datos iniciales
 * Ejecutar: node init-firestore-emulator.js
 */

const admin = require('firebase-admin');
const bcrypt = require('bcryptjs');

// Inicializar Firebase Admin apuntando al emulator
...
async function initializeFirestore() {
    ...
    try {
        ...
        console.log('📋 ACCEDE AL PANEL ADMIN:');
        console.log('   URL: http://localhost:5000/admin/login.html');
        console.log('\n🔐 CREDENCIALES:');
        console.log('   - laforcada@gmail.com / admin123');
        console.log('   - admin@instalacionessl.com.ar / admin123');
        console.log('\n📅 PRUEBA RESERVAS:');
        console.log('   URL: http://localhost:5000/agendar.html\n');
